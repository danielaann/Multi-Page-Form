...
const Headrer = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>Multi Form</h2>
        <button onClick={()=>navigate('/form')} className='border border-gray-500 rounded-full px-8 py-2.5 hover:bg-gray-100 transition-all'>Get Started</button>
    </div>
  )
}
